...
class PULPSoftplusTemplate(NodeTemplate):
...
referenceTemplate = PULPSoftplusTemplate("""
// PULP Softplus (Name: ${nodeName}, Op: ${nodeOp})
PULP_Softplus_s${data_in_type.referencedType.typeWidth}_s${data_out_type.referencedType.typeWidth}(${data_in}, ${data_out}, ${size}, ${input_offset});
""")
